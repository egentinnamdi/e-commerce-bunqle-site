...
export const BestSellers = () => {
    return (
        <div className="inline-flex flex-col items-start gap-[16px] relative">
            <div className="relative  w-[312px] mt-[-1.00px] font-body-medium-600 font-[number:var(--body-medium-600-font-weight)] text-[#00a218] text-[length:var(--body-medium-600-font-size)] tracking-[var(--body-medium-600-letter-spacing)] leading-[var(--body-medium-600-line-height)] [font-style:var(--body-medium-600-font-style)]">
                FEATURED PHONES
            </div>
            <div className="inline-flex items-center justify-center gap-[12px] p-[12px] relative flex-[0_0_auto] bg-gray-00 rounded-[3px] border border-solid border-[#e4e7e9]">
                ...
                <div className="inline-flex flex-col items-start gap-[8px] relative flex-[0_0_auto]">
                    <p className="relative w-[196px] mt-[-1.00px] font-body-small-400 font-[number:var(--body-small-400-font-weight)] text-[#00a218] text-[length:var(--body-small-400-font-size)] tracking-[var(--body-small-400-letter-spacing)] leading-[var(--body-small-400-line-height)] [font-style:var(--body-small-400-font-style)]">
            ...
            <div className="inline-flex items-center justify-center gap-[12px] p-[12px] relative flex-[0_0_auto] bg-gray-00 rounded-[3px] border border-solid border-[#e4e7e9]">
                ...
                <div className="inline-flex flex-col items-start gap-[8px] relative flex-[0_0_auto]">
                    ...
                    <div className="inline-flex items-start gap-[4px] relative flex-[0_0_auto]">
                        <div className="relative w-fit mt-[-1.00px] [font-family:'Public_Sans-Regular',Helvetica] font-normal text-gray-400 text-[14px] tracking-[0] leading-[20px] line-through whitespace-nowrap">
                            $3200
                        </div>
                        <div className="relative w-fit mt-[-1.00px] font-body-small-600 font-[number:var(--body-small-600-font-weight)] text-secondary-500 text-[length:var(--body-small-600-font-size)] tracking-[var(--body-small-600-letter-spacing)] leading-[var(--body-small-600-line-height)] whitespace-nowrap [font-style:var(--body-small-600-font-style)]">
                            $2,300
